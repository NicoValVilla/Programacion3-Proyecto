 ...
 * @author PC
 */
public class registrarPlataforma extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nombre = request.getParameter("nombrePla");
          try {
            Conectadb con = new Conectadb();
            Connection c = con.conectar();
            PreparedStatement registrar = c.prepareStatement("INSERT INTO plataformas (nombre) VALUES (?)");
